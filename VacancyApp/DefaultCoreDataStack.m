...
@implementation DefaultCoreDataStack
...
+ (instancetype) sharedInstance {
    ...
    static DefaultCoreDataStack *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[DefaultCoreDataStack alloc] init];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"VacancyAppDB.sqlite"];
    NSError *error = nil;
